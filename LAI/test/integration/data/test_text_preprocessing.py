...
from LAI.test.integration.data.conf import example_sentence_1, example_sentence_2, example_sentence_4, \
    example_sentence_3
from data.file_loaders import TextPage
from data.text_preprocessing import SpacyNLPTextPreprocessor, Languages
...
def test_split_test(polish_text_preprocessor):
    assert polish_text_preprocessor.count_sentences_in_text(example_sentence_1 + example_sentence_2) == 2
